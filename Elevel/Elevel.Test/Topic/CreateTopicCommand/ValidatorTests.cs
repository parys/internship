using Validator = Elevel.Application.Features.TopicCommands.CreateTopicCommand.Validator;
using Request = Elevel.Application.Features.TopicCommands.CreateTopicCommand.Request;
using Xunit;
using FluentValidation.TestHelper;
using Elevel.Domain.Enums;

namespace Elevel.Test.Topic.CreateTopicCommand
{
